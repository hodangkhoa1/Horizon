const formUpload = document.querySelector("#upload-form"),
        ...
        buttonChange = document.querySelector(".add-image"),
        imageBox = document.querySelector(".button-add-image");
let fileImage;
...
function showImage() {
    ...
    if (validExtensions.includes(fileType)) {
        ...
        buttonChangeConfirm.addEventListener("click", () => {
            let fileURL = fileReader.result;
            imageBox.innerHTML = `<img src="${fileURL}" alt="" >
                                        <input type="hidden" value="${fileURL}" name="imageProduct">`;
            buttonChange.click();
            fileImage = "";
