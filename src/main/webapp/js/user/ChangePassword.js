...
function CheckOldPassword() {
    const inputOldPassword = document.querySelector("#old-password"),
            oldPasswordIconCheck = document.querySelector("#old-password-icon-check"),
            oldPasswordIconError = document.querySelector("#old-password-icon-error"),
            oldPasswordErrorMessage = document.querySelector("#old-password-error");
...
function CheckPasswordStrength() {
    const indicator = document.querySelector(".indicator"),
            inputNewPassword = document.querySelector("#new-password"),
...
function CheckNewPassword() {
    const inputNewPassword = document.querySelector("#new-password"),
            newPasswordIconCheck = document.querySelector("#new-password-icon-check"),
            newPasswordIconError = document.querySelector("#new-password-icon-error"),
            newPasswordErrorMessage = document.querySelector("#new-password-error");
...
function CheckConfirmPassword() {
    const inputConfirmPassword = document.querySelector("#confirm-password"),
            confirmPasswordIconCheck = document.querySelector("#confirm-password-icon-check"),
            confirmPasswordIconError = document.querySelector("#confirm-password-icon-error"),
            confirmPasswordErrorMessage = document.querySelector("#confirm-password-error");
...
function ConfirmPasswordKeyUp() {
    const inputConfirmPassword = document.querySelector("#confirm-password"),
            ...
            showConfirmPasswordIcon = document.querySelector("#show-confirm-password-icon");
