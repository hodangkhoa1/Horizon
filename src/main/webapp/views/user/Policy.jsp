...
<html>
    <head>
        ...
        <title>Policy Page ${sessionScope.LOGIN_USER != null ? "| ".concat(sessionScope.LOGIN_USER.userName) : ""}</title>
        <!-- ICON ON WEB BAR -->
        ...
        <link href="./css/user/Policy.css" rel="stylesheet" type="text/css"/>
                        ...
                        <div>
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p>
                                            <strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Horizon
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Horizon.
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                ...
                                <ul>
                                    <li>
                                        By email: khoahdse150849@fpt.edu.vn
                                    </li>
                                </ul>
                            </div>
                        </div>
