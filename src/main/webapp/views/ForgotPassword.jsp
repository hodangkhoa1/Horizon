...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="./images/iconHorizon.png" type="image/png" sizes="200x138">
        <!-- CSS -->
        ...
        <section class="reset-pwd" style="width: ${CHANGE_PAGE_PASSWORD == null ? '100vw' : ''}; height: ${CHANGE_PAGE_PASSWORD == null ? '100vh' : ''};">
            ...
            <div class="reset-box" style="height: ${CHANGE_PAGE_PASSWORD != null ? '840px' : '650px'}">
                        ...
                        <form action="${pageContext.request.contextPath}/forgot-password" method="post" class="row g-3">
                            ...
                            <c:if test="${CHANGE_PAGE_PASSWORD != null}">
                                <div class="col-12">
                                    ...
                                    <div class="input-field" id="old-password-input-field">
                                        <input onkeyup="OldPasswordKeyUp()" oninput="CheckPassword()" onblur="CheckPassword()" type="password" class="form-control" id="inputOldPassword" placeholder="Your Old Password" name="oldPassword">
                                        <span class="showBtn" id="show-old-password">
                                            <i class="fas fa-eye-slash" id="show-old-password-icon"></i>
                                        </span>
                                        <i class='bx bx-check-circle old-password-icon-check'></i>
                                        <i class='bx bx-error-circle old-password-icon-error'></i>
                                    </div>
                                </div>
                                <div class="col-12 mb-2">
                                    <span class="error_message" id="old-password-error"><%=accountError.getPasswordError()%></span>
                                </div>
                                <div class="col-12">
                ...
                <div class="footer-copy-right">
                    <p>
                        ©
                        <script>document.write(new Date().getFullYear());</script> Horizon website.
                    </p>
                </div>
            </div>
            <c:if test="${CHANGE_PASSWORD_SUCCESS != null}">
