...
public class ChangePasswordAdminController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = this.getServletContext().getRequestDispatcher("/views/admin/ChangePassword.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Account loginUser = (Account) session.getAttribute(LOGIN_ADMIN);

            String oldPassword = request.getParameter("currentpassword");
            String newPassword = request.getParameter("newpassword");
            String confirmPassword = request.getParameter("repeatnewpassword");
