...
public class CartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (userID != null) {
                cartList = cartFacade.getAllCart(userID);
                ...
                boolean checkDeleteCart = cartFacade.delete(userId, cartID);
                if (checkDeleteCart) {
                    cartList = cartFacade.getAllCart(userId);
                    if (cartList.isEmpty()) {
                        request.setAttribute(CART_LIST, null);
            ...
            RequestDispatcher requestDispatcher = this.getServletContext().getRequestDispatcher("/views/user/Cart.jsp");
